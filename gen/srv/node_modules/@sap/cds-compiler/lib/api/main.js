...
function sqlMigration( csn, options, messageFunctions, beforeImage ) {
  ...
  // Sort before the loop below sets `@cds.persistence.skip=true`
  // on unchanged artifacts as a `toSqlDdl` suppression hint; `sortViews`
  // does not process non-persisted entities
