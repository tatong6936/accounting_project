...
## Version 9.9.4 - 2026-07-31

### Changed

- `cds init` uses Maven Java archetype version 4.9.1 for creating Java projects.
- Other dependency updates

## Version 9.9.3 - 2026-06-29

### Fixed

- `cds import` for OData v2 now can import annotations.
- `cds watch` on Windows no longer restarts the server for read-only file opens (antivirus, Windows Search indexer, TypeScript loaders like tsx). A mtime guard now confirms a file was actually written before emitting a `change` event.
