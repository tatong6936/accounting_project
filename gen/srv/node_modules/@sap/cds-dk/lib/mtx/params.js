...
class BasicParams {
    constructor() {
        ...
        this.certificate            = new Param('certificate',            undefined, { obfuscate: ObfuscationLevel.partial }); // client certificate for mTLS
        this.key                    = new Param('key',                    undefined, { obfuscate: ObfuscationLevel.partial }); // private key of the client certificate
...
class AllParams extends BasicParams {
    constructor() {
        ...
        this.directUaa              = new Param('directUaa',              false, { internal: true }); // client-credentials login goes directly to the authorization server
