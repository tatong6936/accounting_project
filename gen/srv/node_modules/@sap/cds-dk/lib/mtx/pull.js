...
module.exports = class Pull {
    ...
    async pullTgz() {
        ...
        const reqAuth = this.params.get('reqAuth') || {};
        const headers = { 'content-type': 'application/json', ...reqAuth.headers };

        const response = await mtxFetch('POST', pullUrl, {
            headers,
            body: JSON.stringify({ tag: this.getExtensionName() })
        }, this.params);
