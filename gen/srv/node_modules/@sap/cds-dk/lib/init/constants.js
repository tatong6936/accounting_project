module.exports = {
    ...
    JAVA_LTS_VERSIONS: [25],
    MAVEN_ARCHETYPE_VERSION: '5.1.1',
    ...
    OPTIONS: Object.freeze({
        ...
        SAMPLE: 'sample',
        HANDLER: 'handler', // influenced by cjs, typer and typescript
        TEST: 'test', // needs sample code
        XSUAA: 'xsuaa',
        IAS: 'ias',
        AMS: 'ams',
        HANA: 'hana',
        HANA_SERVERLESS: 'hana-serverless',
        POSTGRES: 'postgres',
        SQLITE: 'sqlite',
        LIQUIBASE: 'liquibase',
        REDIS: 'redis',
        ...
        EVENT_MESH_SHARED: 'event-mesh-shared',
    ...
    URLS: Object.freeze({
        ...
        CF_INSTALL: 'https://docs.cloudfoundry.org/cf-cli/install-go-cli.html',
        HELM_INSTALL: 'https://helm.sh/docs/intro/install/',
        KUBECTL_INSTALL: 'https://kubernetes.io/docs/tasks/tools/',
