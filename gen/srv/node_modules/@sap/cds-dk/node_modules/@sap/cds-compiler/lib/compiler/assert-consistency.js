...
function assertConsistency( model, stage ) {
  ...
  const schema = {
    ...
    query: {
      ...
      union: {
        ...
        optional: [
          ...
          '_parent', '_main', '_effectiveType', '$effectiveSeqNo', // in FROM
      ...
      select: {                   // sub query
        ...
        optional: [
          'name', '$parens', 'quantifier', 'one', 'mixin', 'excludingDict', 'columns', 'elements',
          '_deps', '$calcDepElement',
    ...
    value: {
      ...
      ref: {
        ...
        optional: [
          ...
          '$extended', '_block', '_outer', // for where/having
        ],
      },
      none: { optional: () => true }, // parse error
    ...
    one: { kind: true, test: locationVal() },
    includes: {
      kind: true,
      test: isArray(),
      inherits: 'type',
    ...
    $queries: {
      ...
      optional: [
        ...
        // query specific
        'where', 'columns', 'mixin', 'quantifier', 'one', 'offset',
