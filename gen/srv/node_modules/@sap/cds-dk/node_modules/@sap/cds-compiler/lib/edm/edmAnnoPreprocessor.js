 ...
 *
 *  Analytical Scenario:
 *    V2 analytical clients don't understand OData V4 vocabulary annotations, therefore
 ...
 *    elements of this structure. Also, the key properties of all structure elements are
 *    removed and a new artificial key element 'key _ID : String' is inserted at first position of
...
function applyAppSpecificLateCsnTransformationOnElement( options, element, struct, error ) {
  // see "Analytical Scenario" in the module-level comment for why this transformation is needed
