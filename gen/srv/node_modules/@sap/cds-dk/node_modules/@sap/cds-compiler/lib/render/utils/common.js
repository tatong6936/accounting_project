...
function renderFunc( funcName, node, renderArgs, utils ) {
  ...
  if (rewriteStandardFunctions) {
    ...
    const that = {
      ...
      error,
      path,
      vector: { embeddingDefaultModel: options.vectorEmbeddingDefaultModel ?? 'SAP_GXY.20250407', embeddingHanaDefaultRemoteSource: options.vectorEmbeddingHanaDefaultRemoteSource ?? 'AI_CORE' },
    };
