...
function _compile_for_nodejs (csn, o) {
  ...
  text_to_search: for (const name in dsn.definitions) {
    ...
    for (const name in def.associations) {
      ...
      if (!commonTextRef) {
        // For annotation expression values, '=' property is set to true or undefined
        if (typeof annotationValue['='] !== 'string') continue
        commonTextRef = annotationValue['='].split('.')
      }
