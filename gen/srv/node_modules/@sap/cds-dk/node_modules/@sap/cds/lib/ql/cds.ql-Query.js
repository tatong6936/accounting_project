...
class Query {
  ...
  _add (property, values) {
    let $ = this[this.kind], former = $[property]
    if (cds.env.features.compat_clone_appends && !Object.hasOwn($,property)) former = undefined
    $[property] = !former ? values : [ ...former, ...values ]
    return this
  }
