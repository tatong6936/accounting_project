...
class type extends any { is(kind) { return kind === 'type' || super.is(kind) }
  isComputed() {
    return this['@Core.Computed'] || this.value
  }
  toJSON() {
...
class action extends any { constructor(aspects) { super({ kind:'action', ...aspects }) } }
class fnction extends action { constructor(aspects) { super({ kind:'function', ...aspects }) } }
...
exports = module.exports = {
  ...
  service, event, action, function: fnction,
  context,
