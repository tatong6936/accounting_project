...
module.exports = adapter => {
  ...
  return function odata_service_document(req, res) {
    ...
    // service.entities does not work because it excludes the texts entities
    const srvEntities = service.reflect(d => d.kind === 'entity')
