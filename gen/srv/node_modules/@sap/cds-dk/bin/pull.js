module.exports = Object.assign(pull, {
    options: ['--subdomain', '--passcode', '--user', '--client', '--mtls', '--from'],
    flags: [],
    shortcuts: ['-s', '-p', '-u', '-c', '-m'],
    help: `
# SYNOPSIS
