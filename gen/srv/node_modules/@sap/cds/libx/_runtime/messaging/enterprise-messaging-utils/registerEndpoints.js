...
class EndpointRegistry {
  constructor(basePath, LOG) {
    ...
    const _HAS_MESSAGING_XSUAA = !!cds.env.requires.messaging?.xsuaa
    const _IS_SECURED = _HAS_APP_AUTH || _HAS_MESSAGING_XSUAA
    ...
    } else if (_IS_PRODUCTION) {
      throw new Error(
        'Messaging endpoints require authentication in production. Configure cds.requires.auth or cds.requires.messaging.xsuaa.'
      )
    }
