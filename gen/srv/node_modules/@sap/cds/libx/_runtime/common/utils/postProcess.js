...
const postProcess = (req, result, service, onlySelectAliases = false) => {
  ...
  if (transitions) {
    if (Array.isArray(result) && 'affected' in result) {
      ...
      result = revertData(result.length ? result : req.data, transitions.at(-1), service)
      result.affected = affected
    } else {
      result = revertData(result, transitions.at(-1), service)
    }
  }
