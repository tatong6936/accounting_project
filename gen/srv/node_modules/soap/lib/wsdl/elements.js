...
class Element {
    ...
    endElement(stack, nsName) {
        if (this.nsName === nsName) {
            ...
            if (this !== stack[0]) {
                (0, utils_1.defaultsDeep)(stack[0].xmlns, this.xmlns);
                // delete this.xmlns;
...
class RestrictionElement extends Element {
    constructor() {
        super(...arguments);
        this.allowedChildren = buildAllowedChildren(['all', 'choice', 'enumeration', 'group', 'sequence', 'attribute']);
    }
    description(definitions, xmlns) {
        const children = this.children;
        let desc;
        ...
        if (desc && this.$base) {
            ...
            if (typeElement) {
                ...
                if (baseDescription[AttributeElement.Symbol]) {
                    (0, utils_1.defaults)($attributes, baseDescription[AttributeElement.Symbol]);
                }
                desc = (0, utils_1.defaults)(desc, baseDescription);
            }
            return desc;
        }
...
class ExtensionElement extends Element {
    constructor() {
        super(...arguments);
        this.allowedChildren = buildAllowedChildren(['all', 'choice', 'group', 'sequence']);
    }
    description(definitions, xmlns) {
        let desc = {};
        for (const child of this.children) {
        ...
        if (this.$base) {
            ...
            if (typeName in Primitives) {
                ...
                if (typeElement) {
                    ...
                    desc = typeof base === 'string' ? base : (0, utils_1.defaults)(base, desc);
                }
            }
        }
        return desc;
...
class ChoiceElement extends Element {
    constructor() {
        super(...arguments);
        this.allowedChildren = buildAllowedChildren(['any', 'choice', 'element', 'group', 'sequence']);
    }
    description(definitions, xmlns) {
        const choice = {};
        for (const child of this.children) {
...
class GroupElement extends Element {
    constructor() {
        super(...arguments);
        this.allowedChildren = buildAllowedChildren(['annotation', 'all', 'choice', 'sequence']);
    }
    ...
    description(definitions, xmlns) {
        if (this.$ref) {
            const q = (0, utils_1.splitQName)(this.$ref);
            ...
            const defn = schema && schema.groups && schema.groups[q.name];
            if (defn) {
...
class ComplexTypeElement extends Element {
    constructor() {
        super(...arguments);
        this.allowedChildren = buildAllowedChildren(['all', 'annotation', 'choice', 'complexContent', 'group', 'sequence', 'simpleContent', 'attribute']);
    }
    description(definitions, xmlns) {
        let ret = {};
        let isFirstChild = false;
        ...
        for (const child of children) {
            ...
            if (!isFirstChild &&
                (child instanceof ChoiceElement || child instanceof SequenceElement || child instanceof GroupElement || child instanceof AllElement || child instanceof SimpleContentElement || child instanceof ComplexContentElement)) {
                isFirstChild = true;
...
class SchemaElement extends Element {
    constructor() {
        super(...arguments);
        this.allowedChildren = buildAllowedChildren(['complexType', 'element', 'group', 'import', 'include', 'simpleType']);
        this.complexTypes = {};
        this.groups = {};
        this.types = {};
        this.elements = {};
    ...
    merge(source) {
        ...
        (0, utils_1.merge)(this.complexTypes, source.complexTypes);
        (0, utils_1.merge)(this.groups, source.groups);
        (0, utils_1.merge)(this.types, source.types);
        (0, utils_1.merge)(this.elements, source.elements);
        (0, utils_1.merge)(this.xmlns, source.xmlns);
        // Merge attributes from source without overwriting our's
        (0, utils_1.merge)(this, (0, utils_1.pickBy)(source, (value, key) => {
...
class DefinitionsElement extends Element {
    ...
    addChild(child) {
        if (child instanceof TypesElement) {
            ...
            (0, utils_1.merge)(this.schemas, child.schemas);
        }
