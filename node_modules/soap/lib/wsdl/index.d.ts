...
export declare class WSDL {
     ...
     * @param {String} type
     */
    objectToDocumentXML(name: string, params: any, nsPrefix: string, nsURI?: string, type?: string, options?: any): any;
    /**
    ...
    private _xmlnsMap;
    private _orderIndexCache;
    private _getOrderIndexFor;
    private _orderElementKeys;
    private _addSpecialKeys;
}
