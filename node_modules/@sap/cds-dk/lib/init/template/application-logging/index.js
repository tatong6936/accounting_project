...
module.exports = class ApplicationLoggingTemplate extends require('../../plugin') {
    ...
    async canRun() {
        const { hasMta, hasKyma } = readProject()
        if (hasKyma && !hasMta) throw `'cds add application-logging' is not available for Kyma yet`
        return true
    }
    ...
    async combine(facet) {
        ...
        const { addMta, hasMta, hasApprouter, isJava, addMultitenancy, hasMultitenancy, srv } = project
