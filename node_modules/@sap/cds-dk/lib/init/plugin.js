module.exports = class Plugin {
     ...
     * @param {string} [facet] This plugin's facet name, forwarded to `readProject(facet)`
     *   so `add<Facet>` accessors can tell whether this facet is the one being added.
     */
    async combine(facet) { } // eslint-disable-line no-unused-vars
