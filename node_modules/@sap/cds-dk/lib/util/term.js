...
const as = module.exports.as = (codes, o) => {
  return format.colors ? (codes + o + t.reset) : ('' + o)
}
...
const forceColor = process.env.FORCE_COLOR && process.env.FORCE_COLOR !== 'false'
const rendersColors = process.stdout.isTTY && process.stderr.isTTY || process.env.GITHUB_ACTIONS
format.colors = rendersColors && !process.env.NO_COLOR || forceColor
