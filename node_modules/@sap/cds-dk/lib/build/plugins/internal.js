...
module.exports = class InternalBuildPlugin extends require('./plugin') {
    ...
    async collectLanguageBundles(model, bundleDest) {
        ...
        if (bundleDest && Object.keys(bundles).length > 0) {
            ...
            await this.collectMessageBundles(bundleDest, model)
            return { file, bundles }
        }
        return null
    }
     ...
     * @param {string} bundleDest
     * @param {Object} model - passed for signature consistency with subclass overrides; not used here
     * as Java does not require neighborhood resolution of plugin i18n files.
     */
