...
module.exports = Object.assign (inspect, {
    staticCompletions: () => ({
        '--kind': ['entity', 'aspect', 'type', 'service'],
        '--list': ['names', 'elements', 'keys', 'associations', 'compositions', 'ids', 'sources', 'all'],
        '-l':     ['names', 'elements', 'keys', 'associations', 'compositions', 'ids', 'sources', 'all'],
