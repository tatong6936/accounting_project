...
optionProcessor.command('Q, toSql')
  ...
  .option('    --draft-admin-data-constraints')
  ...
  Options
   ...
   --draft-admin-data-constraints   Generate an "ON DELETE CASCADE" referential constraint on the
                                    DraftAdministrativeData_DraftUUID foreign key of draft shadow
                                    tables. Independent of assertIntegrity / assertIntegrityType.
