 ...
 */
export const defaults = { name: '@cap/eslint/defaults',
 ...
 */
export const tests = { name: '@cap/eslint/tests',
 ...
 */
export const browser = { name: '@cap/eslint/browser',
 ...
 */
export default Object.assign ([ ...recommended,
  { files: ['bin/*.js'], rules: { 'no-console': 'off' } },
  { ignores:[ '**/libx/odata/parse/parser.js' ] },
