...
module.exports = exports = {
  ...
  features: {
    ...
    deploy_via_upserts: undefined,
    assert_integrity: false,
    precise_timestamps: false,
    ieee754compatible: true,
    compat_clone_appends: false, //> remove with cds^11
    count_as_string: undefined,
    compat_srv_getters: false, //> remove with cds^11
    compat_texts_entities: false, //> remove with cds^11
    legacy_srv_results: false, //> remove with cds^11
    legacy_db_results: true, //> switch default with cds^11?
    bulk_inserts_via_rest: true, //> remove with cds^11
  ...
  log: {
    ...
    user: false,
    mask_headers: ['/authorization/i', '/cookie/i', '/cert/i', '/ssl/i', '/api-key/i'],
  ...
  i18n: {
    ...
    /** @deprecated */ fatjson: false, // REVISIT: remove in cds^11
    '[java]': { fatjson: true },
  },
  ...
  remote: {
    native_fetch: undefined,
    timeout: '10s',
    cache_size: 0,
    cache_expiry_buffer: '5min',
  },
