...
function _getOpenApiForMultipleServices(csdl, csn, options) {
  let openApiDocs = {};
  for (const [content, metadata] of csdl) {
    const parsedContent = typeof content === "string" ? JSON.parse(content) : content;
    const openApiOptions = toOpenApiOptions(parsedContent, csn, options);
    const openApiDocsForService = _getOpenApi(parsedContent, openApiOptions, metadata.file);
