...
module.exports.csdl2openapi = function (
     ...
     * @param {*} serversObject Input servers object
     ...
     * @param {*} options.element Model element of navigation segment
     * @param {*} options.root Root model element
     ...
     * @param {string} options.sourceName Name of path source
     * @param {string} options.targetName Name of path target
     * @param {null | object} options.target Target container child of path
     * @param {number} options.level Number of navigation segments so far
     * @param {string} options.navigationPath Path for finding navigation restrictions
     ...
     * @param {object} options
     * @param {*} options.pathItem Path Item Object to augment
     * @param {*} options.element Model element of navigation segment
    ...
    function operationCreate({ pathItem, element, name, sourceName, targetName, target, level, restrictions }) {
        ...
        if (insertRestrictions.Insertable !== false) {
            ...
            const type = meta.modelElement(element.$Type);
            pathItem.post = {
                summary: insertRestrictions.Description || operationSummary({
                    operation: 'Creates',
                    name,
                    sourceName,
                    level,
                ...
                responses: response({
                    code: 201,
                    description: `Created ${lname}`,
                    type: { $Type: element.$Type },
                    errors: insertRestrictions.ErrorResponses,
     ...
     * @param {object} options
     * @param {string} options.operation Operation (verb)
     * @param {string} options.name Name of navigation segment
     * @param {string} options.sourceName Name of path source
     * @param {number} options.level Number of navigation segments so far
     * @param {boolean} options.collection Access a collection
     * @param {boolean} options.byKey Access by key
    ...
    function operationRead({ pathItem, element, name, sourceName, targetName, target, level, restrictions, byKey, nonExpandable }) {
        ...
        if (readable) {
            ...
            const operation = {
                summary: descriptions.Description || operationSummary({
                    operation: 'Retrieves',
                    name,
                    sourceName,
                    level,
                ...
                responses: response({
                    code: 200,
                    description: `Retrieved ${byKey ? pluralize.singular(lname) : lname}`,
                    type: { $Type: element.$Type, $Collection: collection },
                    errors: byKey ? readByKeyRestrictions?.ErrorResponses : readRestrictions?.ErrorResponses,
                    isCount: !countRestrictions
                })
            };
     ...
     * @param {*} operation Operation object to augment
     * @param {*} restrictions Restrictions for operation
     */
     ...
     * @param {*} custom custom parameter in OData format
     ...
     * @param {Array} parameters Array of parameters to augment
     * @param {*} element Model element of navigation segment
     * @param {null | TargetRestrictions} target Target container child of path
...
see [Expand](http://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html#sec_SystemQueryOptionexpand)',
     ...
     * @param {Array} parameters Array of parameters to augment
     * @param {null | TargetRestrictions} target Target container child of path
     * @param {*} restrictions Navigation property restrictions of navigation segment
     */
     ...
     * @param {string | *} member Qualified name of referenced type
     ...
     * @param {string | *} path Qualified name of referenced type
     * @return {*} Reference Object
     */
    ...
    function operationUpdate({ pathItem, element, name, sourceName, target, level, restrictions, byKey = false }) {
        ...
        if (updateRestrictions.Updatable !== false && !element[meta.voc.Core.Immutable]) {
            ...
            const type = meta.modelElement(element.$Type);
            const operation = {
                summary: updateRestrictions.Description || operationSummary({
                    operation: 'Changes',
                    name,
                    sourceName,
                    level,
                ...
                responses: response({
                    ...
                    description: "Success",
                    type: undefined,
                    errors: updateRestrictions.ErrorResponses,
                    isCount: !countRestrictions
                }),
            };
    ...
    function operationDelete({ pathItem, element, name, sourceName, target, level, restrictions, byKey = false }) {
        ...
        if (deleteRestrictions.Deletable !== false) {
            pathItem.delete = {
                summary: deleteRestrictions.Description || operationSummary({
                    operation: 'Deletes',
                    name,
                    sourceName,
                    level,
                ...
                responses: response({
                    ...
                    description: "Success",
                    type: undefined,
                    errors: deleteRestrictions.ErrorResponses,
                    isCount: !countRestrictions
                }),
            };
     ...
     * @param {object} options
     * @param {*} options.paths The Paths Object to augment
     * @param {string} options.prefix Prefix for path (the key-qualified entity path)
     * @param {Array} options.prefixParameters Parameter Objects for prefix
     * @param {*} options.type Entity type object
     ...
     * @param {string} options.prefix Prefix for path
     * @param {Array} options.prefixParameters Parameter Objects for prefix
     * @param {*} options.type Entity type object of navigation segment
     * @param {*} options.root Root element
     * @param {string} options.sourceName Name of path source
     * @param {number} options.level Number of navigation segments so far
     * @param {string} options.navigationPrefix Path for finding navigation restrictions
     */
    ...
    /**
     * Collect navigation paths of a navigation segment and its potentially structured components
     * @param {*} type Structured type
     * @param {*} map Map of navigation property paths and their types
     * @param {string} prefix Navigation prefix
     * @param {number} level Number of navigation segments so far
     * @return {*} Map of navigation property paths and their types
     */
     ...
     * @return {array | null} Key of entity type or null
     */
     ...
     * @param {*} entityType Entity Type object
     * @param {number} level Number of navigation segments so far
     * @return {*} key: Key segment, parameters: key parameters
     */
     ...
     * @param {string} options.prefix Prefix for path
     * @param {Array} options.prefixParameters Parameter Objects for prefix
     * @param {*} options.element Model element the operations are bound to
     * @param {string} options.sourceName Name of path source
     * @param {boolean} [options.byKey=false] Read by key
     */
    ...
    * @param {*} child Action import object
    */
     ...
     * @param {string} options.prefix Prefix for path
     * @param {Array} options.prefixParameters Parameter Objects for prefix
     * @param {string} options.actionName Qualified name of function
     * @param {*} options.overload Function overload
     * @param {string} options.sourceName Name of path source
    ...
    function pathItemAction({ paths, prefix, prefixParameters, actionName, overload, sourceName, actionImport = {} }) {
        ...
        const pathItem = {
            post: {
                ...
                responses: overload.$ReturnType ? response({
                    code: 200,
                    description: "Success",
                    type: overload.$ReturnType,
                    errors: overload[meta.voc.Capabilities.OperationRestrictions]?.ErrorResponses
                }) : response({
                    code: 204,
                    description: "Success",
                    type: undefined,
     ...
     * @param {*} child Function import object
     */
    function pathItemFunctionImport(paths, name, child) {
        ...
        overloads && overloads.filter(overload => !overload.$IsBound).forEach(overload => pathItemFunction({
            paths,
            prefix: `/${name}`,
            prefixParameters: [],
     ...
     * @param {string} options.prefix Prefix for path
     * @param {Array} options.prefixParameters Parameter Objects for prefix
     * @param {string} options.functionName Qualified name of function
     * @param {*} options.overload Function overload
     * @param {string} options.sourceName Name of path source
     ...
     * @param {object} options
     * @param {string | number} options.code HTTP response code
     * @param {string} options.description Description
     * @param {*} options.type Response type object
     * @param {array} options.errors Array of operation-specific status codes with descriptions
     * @param {boolean} [options.isCount=true]
    ...
    function getSchemas(csdl) {
        ...
        for (const r of requiredSchemas.list) {
            ...
            switch (type.$Kind) {
                case "ComplexType":
                case "EntityType":
                    schemasForStructuredType({ schemas: unordered, qualifier: r.namespace, name: r.name, type, suffix: r.suffix });
                    break;
                case "EnumType":
    ...
    /**
     * Construct Schema Objects from the types of the CSDL document
     * @param {*} schemas Map of Schema Objects to augment
     */
     ...
     * @param {object} options
     * @param {*} options.schemas Map of Schema Objects to augment
     * @param {string} options.qualifier Qualifier for structured type
     * @param {string} options.name Simple name of structured type
     * @param {*} options.type Structured type
     ...
     * @param {*} type Structured type
     * @param {*} schema OpenAPI schema to augment
     */
     ...
     * @param {*} element referencing a type
    ...
    function getSchema(element, suffix = '', forParameter = false, forFunction = false) {
        ...
        if (element[meta.voc.Validation.Maximum] !== undefined) {
            ...
            } else if (isNumberSchema(s)) {
                s.maximum = element[meta.voc.Validation.Maximum];
            }
        ...
        if (element[meta.voc.Validation.Minimum] !== undefined) {
            ...
            if (isAnyOfSchema(s) && isNumberSchema(s.anyOf[0])) {
                ...
                s.minimum = element[meta.voc.Validation.Minimum];
            }
            // TODO: see above
            // @ts-expect-error
     ...
     * @param {*} schema Schema Object to augment
     * @param {*} element Model element
     */
     ...
     * @param {*} components Components Object to augment
     * @param {*} entityContainer Entity Container object
     */
     ...
     * @param {*} openapi OpenAPI document to augment
     * @param {*} entityContainer Entity Container object
     */
