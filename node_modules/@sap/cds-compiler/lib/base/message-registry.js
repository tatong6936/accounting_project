...
const centralMessages = {
  ...
  'ref-missing-backlink-element': { severity: 'Warning', errorFor: [ 'v8' ] },
  'ref-deprecated-backlink': { severity: 'Warning', errorFor: [ 'v8' ] },
  ...
  'ext-unstable-order':         { severity: 'Warning' },
  ...
  'def-unsupported-assoc': { severity: 'Warning' },
...
const centralMessageTexts = {
  ...
  'syntax-invalid-anno-struct': {
    std: 'Objects with properties $(PROP) and $(SIBLINGPROP) are reserved for expressions and can\'t be used as structures',
    xpr: 'Objects with $(PROP) as only property are reserved for expressions and can\'t be used as structures',
    '...': 'Objects with $(PROP) as only property are reserved for appending arrays and can\'t be used as structures',
    '#': 'Objects with a property $(PROP) are reserved for enum values and can\'t be used as structures',
    ref: 'The value of property $(PROP) in structures must be a non-empty string',
  },
  ...
  'syntax-unexpected-sql-clause': {
    ...
    one: '$(CODE) is supported only in standalone queries, not in CDS models',
  },
  ...
  'rewrite-undefined-key': {
    ...
    // TODO: delete text variant 'backlink' again
  },
  ...
  'ref-deprecated-backlink': {
    std: 'The target $(TARGET) of the backlink association is just distantly related to the current entity; do not use a comparison with $(ID)',
    inferred: 'The target $(TARGET) of the backlink association $(NAME) is just distantly related to the current entity; provide an ON-condition not using a comparison with $(ID)',
  },
  'ref-missing-backlink-element': {
    std: 'Element $(ID) must also be projected when projecting this association containing a backlink comparison',
    def: 'Element $(ID) must be projected when defining this association containing a backlink comparison',
  },
  'extend-columns': {
