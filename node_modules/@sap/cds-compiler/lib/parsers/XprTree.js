...
// Operators that make an expression a predicate (condition) rather than a value.
const MAX_PREDICATE_PRECEDENCE = 13;
const predicateOperators = new Set( [
  ...Object.keys( binaryOperators ).filter( op => binaryOperators[op] <= MAX_PREDICATE_PRECEDENCE ),
  'exists', 'not',
] );
